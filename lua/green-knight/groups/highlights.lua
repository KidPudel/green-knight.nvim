...
function M.highlight(palette, opts)
	return {
		...
		Pmenu = { fg = palette.white, bg = palette.accent },
		PmenuSel = { bg = palette.white, fg = palette.white, reverse = true },
		...
		Comment = vim.tbl_extend("force", { fg = palette.white }, opts.styles.comments),
		Folded = { fg = palette.white, bg = palette.green_pale },
		...
		DiffAdd = { bg = palette.green_pale },
		DiffText = { bg = palette.green_pale },
		Changed = {
			fg = palette.orange,
		},
		DiffChange = {
		...
		MatchParen = vim.tbl_extend(
			"force",
			{ fg = palette.white, bg = palette.green, underline = true },
		...
		Keyword = vim.tbl_extend("force", { fg = palette.white_blue }, opts.styles.keywords),
